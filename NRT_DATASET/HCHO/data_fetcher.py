...
def fetch_and_manage_tempo_hcho_granules(output_dir: str = "./NRT_DATASET/HCHO/tempo_data"):
        ...
        # Initialize an empty DataFrame for granules to delete
